...
<head>
    ...
    <script type="text/javascript" src="js/old junk/tests-timer.js"></script>
...
<td class="gameAreaLayout">
    ...
    <div class="gameArea" id="gameArea">
        ...
        <?php include 'views/testSidebar.php'; ?>
        </div>
        <!-- TOP LINKS -->
        <div class="titleBand">
        ...
        <div class="controlPanel top-c-panel nonSelectable">
            <table class="controlPanelLayout" cellpadding="0">
                <tbody><tr>
                    <td id="tb-prev-task" class="cpButton cpNormal nonSelectable switched-off">Предыдущий вопрос</td>
                    <td id="tb-next-task" class="cpButton cpNormal nonSelectable  switched-off">Следующий вопрос</td>
                    ...
                    <td id="tb-finish-test" class="cpButton cpNormal nonSelectable switched-off">Закончить тест</td>
                </tr>
            </tbody></table>
        </div>
        ...
        <div id="field"> 
        <?php include 'views/testMain.php'; ?>
        </div>
